...
require_once 'src/lib/DmColor/DmColor.php';
require_once 'src/lib/DmImage/DmImage.php';
require_once 'src/lib/DmImage/DmImageFile.php';
require_once 'src/lib/DmImage/Filters/DmImageFitFilter.php';
require_once 'src/lib/DmImage/Filters/DmImageCropFilter.php';
require_once 'src/lib/DmImage/Filters/DmImageInstagramLoFiFilter.php';
require_once 'src/lib/DmImage/Filters/DmImageInstagramWaldenFilter.php';
require_once 'src/lib/DmImage/Filters/DmImageInstagramToasterFilter.php';

$image = new DmImage(400,400, 0x002033FF);
$image
	->graphics
...
$image2 = new DmImage(200,200, 0x00FFFFFF);
$image2
	->graphics
	->lineStyle(5,0x30FF0000)
	->fillStyle(0x6033FF00)
...
$filter = new DmImageInstagramLoFiFilter(300,1);
$filter2 = new DmImageInstagramWaldenFilter(300,2);
$filter3 = new DmImageInstagramToasterFilter(300);

$image = new DmImageFile('/home/www/demouth/www/docroot/git/dmpiechart/src/lib/DmImage/02.jpeg');
$image->applyFilter($filter);

?><img src="<?=$image->toDataSchemeURI()?>" /><?php

$image2 = new DmImageFile('/home/www/demouth/www/docroot/git/dmpiechart/src/lib/DmImage/02.jpeg');
...
$filter = new DmImageInstagramLoFiFilter(300,3);
$image3 = new DmImageFile('/home/www/demouth/www/docroot/git/dmpiechart/src/lib/DmImage/lena_std.png');
$image3->applyFilter($filter);

?><br><img src="<?=$image3->toDataSchemeURI()?>" /><?php

$filter2 = new DmImageInstagramWaldenFilter(300,0);
$image4 = new DmImageFile('/home/www/demouth/www/docroot/git/dmpiechart/src/lib/DmImage/lena_std.png');
